 ...
 * <p>
 * ValidationException из add() если автобус с таким же рег номером (regNumber) уже есть в коллекции. У нас же
 * не может быть автобусов с одинаковыми госномерами, поэтому это ошибка валидации
 * <p>
